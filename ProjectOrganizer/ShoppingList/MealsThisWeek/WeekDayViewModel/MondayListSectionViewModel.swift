//
//  MondayListSectionViewModel.swift
//  ProjectOrganizer
//
...
extension MondayListSection {
    class ViewModel: NSObject, ObservableObject, NSFetchedResultsControllerDelegate {
        let dataController: DataController

        var sortOrder = Item.SortOrder.optimized
        let mondayAssignment: Bool
        ...
        init(dataController: DataController, mondayAssignment: Bool) {
            ...
            self.mondayAssignment = mondayAssignment
            ...
            request.predicate = NSPredicate(format: "mondayAssignment = %d", mondayAssignment)
